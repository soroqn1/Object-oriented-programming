...
public class DerivedProcessing : Processing
{
    public DerivedProcessing() : base() {}

    public DerivedProcessing(string inputCS2,string oldletterCS2,string newletterCS2,string inputCS3,string oldletterCS3,string newletterCS3
    ) : base(inputCS2, oldletterCS2, newletterCS2, inputCS3, oldletterCS3, newletterCS3)
    {
    }
}
}