...
class AdvancedStringManipulator : public StringManipulator {
public:
    AdvancedStringManipulator(std::string input, char oldLetter, char newLetter)
        : StringManipulator(input, oldLetter, newLetter) {}
};